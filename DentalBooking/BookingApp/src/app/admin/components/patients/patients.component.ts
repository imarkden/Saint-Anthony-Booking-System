...
export class PatientsComponent {
  ...
  isTimeAvailable(hour: number, minute: string): boolean {
    ...
    if (this.patientsDoctor && Array.isArray(this.patientsDoctor)) {
      for (const patient of this.patientsDoctor.filter((p)=> p.selectedDoctor === this.selectDoctor)) {
